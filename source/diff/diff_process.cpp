...
static TreeNode* diffPow(Differentiator* diff, TreeNode* left, TreeNode* right, size_t var_idx);

static TreeNode* diffLog(Differentiator* diff, TreeNode* left, TreeNode* right, size_t var_idx);
